define([
        ...
        GEOQA.prototype.getHomologous = function (parameters, attributes) {
            ...
            this.helper.download(JSON.stringify(m2), "TARGET_homologous_init.txt");
...
/*
                ...
                self.helper.cleanAllMarkers(minDistance, maxDistance);
                ...
                markerLeaflet1.forEach(function (marker, i) {
                    ...
                    self.helper.insertMarker(self.map1, marker.x, marker.y, (i + 1), self.markers1, "map1", color, 1, distanceHomologous);
                });
                markerLeaflet2.forEach(function (marker, i) {
                    var distanceHomologous = marker.distance;
                    var color = self.helper.getColor(((distanceHomologous - minDistance) / (maxDistance - minDistance)) * 100, colors);
                    self.helper.insertMarker(self.map2, marker.x, marker.y, (i + 1), self.markers2, "map2", color, 1, distanceHomologous);
                });

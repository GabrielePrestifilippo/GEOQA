...
public class Domain {
    ...
    private double lowerBound, upperBound, widthInterval, lowerValue, upperValue;
    private int sizeD;
    ...
    public Domain(double a, double b, double w) {
        ...
        lowerBound = a;
        upperBound = b;
        lowerValue = lowerBound + 0.5 * widthInterval;
        upperValue = upperBound - 0.5 * widthInterval;
        sizeD = (int) Math.rint((b - a) / w);
    }
    ...
    public int getIndex(double x) {
        ...
        if (x > upperBound) {
            ...
            return (int) Math.rint((x - lowerValue) / widthInterval);
        }
    }
    ...
    public double getBound(int i) {
        return lowerBound + i * widthInterval;
    }
     ...
     * index
     */
    public double getValore(int i) {
        return lowerValue + i * widthInterval;
    }
     ...
     */
    public double getWidthPartition() {
